...
def test_play_trained_agent_bid_dog(mocker):
    ...
    mocker.patch('french_tarot.agents.trained_player_bid.BidPhaseAgent.create_dqn', mock_create_dog_phase_dqn)
    ...
    play_trained_agent.main(n_episodes_training=10, device="cpu")
